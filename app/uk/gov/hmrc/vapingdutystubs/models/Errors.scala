...
object EtmpDownstreamError {
  implicit val etmpDownstreamErrorWrites: OFormat[EtmpDownstreamError] = Json.format[EtmpDownstreamError]
}
...
case class EtmpDownstreamErrorDetails(code: String, text: String, processingDate: String)

object EtmpDownstreamErrorDetails {
  implicit val etmpDownstreamErrorDetailsWrites: OFormat[EtmpDownstreamErrorDetails] =
    Json.format[EtmpDownstreamErrorDetails]
}
